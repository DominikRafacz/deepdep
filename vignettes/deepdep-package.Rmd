...
plot_dependencies("DT", depth = 2, deps_types = c("Imports", "Depends", "Suggests"))
```


In each of the plots you can see one package name in the center and two circles of packages gathered around them. These are depdendencies of the first and second level.
...
Not all dependencies are plotted. To increase readibility, dependencies on the same level are hidden, but you can change this behaviour
