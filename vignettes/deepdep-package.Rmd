...
head(t, 20)
#>            A3         aaSEA      AATtools           aba        ABACUS    abbreviate        abbyyR 
#>          "A3"       "aaSEA"    "AATtools"         "aba"      "ABACUS"  "abbreviate"      "abbyyR" 
#>           abc      abc.data       ABC.RAP        abcADM   ABCanalysis      abcdeFBA      ABCoptim 
#>         "abc"    "abc.data"     "ABC.RAP"      "abcADM" "ABCanalysis"    "abcdeFBA"    "ABCoptim" 
...
#>  [7] "a4Reporting"   "aaSEA"         "AATtools"      "aba"           "ABACUS"        "ABAData"      
#> [13] "ABAEnrichment" "ABarray"       "abbreviate"    "abbyyR"        "abc"           "abc.data"     
#> [19] "ABC.RAP"       "abcADM"
```
...
head(t, 20)
#>  [1] "abind"         "ada"           "adabag"        "ade4"          "AmyloGram"     "AmyloGraph"   
#>  [7] "ape"           "askpass"       "assertthat"    "auprc"         "backports"     "base64enc"    
#> [13] "base64url"     "BBmisc"        "bench"         "BH"            "binman"        "Biobase"      
#> [19] "BiocFileCache" "BiocGenerics"
```
...
#> last_week      624984
#> last_month    2907449
#> last_quarter  9372953
#> last_half    15718347
#> grand_total  69842476
```
...
#> 1   digest      <NA> Imports    31140    223957    1004201      2961775   5063707    43488490
#> 2     glue      <NA> Imports    46782    332596    1548055      4326287   7518526    42648899
#> 3   gtable  >= 0.1.1 Imports    20523    148076     663740      2045040   3419183    26799787
#> 4  isoband      <NA> Imports    23337    171581     774985      2424963   4424341    16039607
#> 5     MASS      <NA> Imports     4435     29420     144260       429820    807077     9407911
#> 6     mgcv      <NA> Imports     3043     28380     122902       443119    717887     6923089
#> 7    rlang >= 0.4.10 Imports    67589    466036    2058064      6522618  12041457    67053249
#> 8   scales  >= 0.5.0 Imports    23543    167897     750848      2325292   3967248    34030068
#> 9   tibble      <NA> Imports    43815    321630    1432768      4492491   8275469    51598574
#> 10   withr  >= 2.0.0 Imports    36177    249480    1108858      3278829   5898847    30694911
```
