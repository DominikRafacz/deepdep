...
head(t, 20)
#>  [1] "AmyloGraph"  "askpass"     "assertthat"  "attempt"     "backports"   "base64enc"  
#>  [7] "BiocManager" "bit"         "bit64"       "brew"        "brio"        "bslib"      
#> [13] "cachem"      "callr"       "checkmate"   "cli"         "clipr"       "colorspace" 
#> [19] "commonmark"  "config"
```
...
#> last_week      626638
#> last_month    3033011
#> last_quarter  9431512
#> last_half    15537309
#> grand_total  69217492
```
...
#>       name   version    type last_day last_week last_month last_quarter last_half
#> 1   digest      <NA> Imports    40118    280344     998778      2946767   4999386
#> 2     glue      <NA> Imports    57487    368681    1622243      4292363   7426334
#> 3   gtable  >= 0.1.1 Imports    25966    152202     682907      2052183   3381201
#> 4  isoband      <NA> Imports    29594    175889     799871      2447000   4408503
#> 5     MASS      <NA> Imports     5365     37135     150078       431082    814860
#> 6     mgcv      <NA> Imports     5930     22923     125990       432545    718016
#> 7    rlang >= 0.4.10 Imports    75335    478059    2104980      6542990  12011815
#> 8   scales  >= 0.5.0 Imports    29913    173077     771297      2339874   3929950
#> 9   tibble      <NA> Imports    52234    328894    1505198      4522001   8256585
#> 10   withr  >= 2.0.0 Imports    44466    283089    1106321      3281612   5865575
#>    grand_total
#> 1     43264533
#> 2     42316303
#> 3     26651711
